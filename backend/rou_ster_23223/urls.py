"""rou_ster_23223 URL Configuration
...
admin.site.site_header = "Rou-ster"
admin.site.site_title = "Rou-ster Admin Portal"
admin.site.index_title = "Rou-ster Admin"

# swagger
api_info = openapi.Info(
    title="Rou-ster API",
    default_version="v1",
    description="API documentation for Rou-ster App",
)
